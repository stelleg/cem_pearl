...
action in the transition from the first state to the second, which simple pushes
the argument term with the current environment onto the stack. The Lam rule is
...
enter the closure $\lambda j.j[0]$.}
\label{fig:states}
\end{figure*}
